...
/*
    ...
    Minimalistic Debian Package Upgrade Tool with Web-Frontend by Robert Klikics, RobHost GmbH [rk@robhost.de], 2007-2011
...
<body>
<h1>Updian - UpdateDebian v0.3</h1>
<h4>by <a href="http://www.robhost.de/updian/">RobHost GmbH</a>, 2007-2011 </h4>
<hr>
...
if($_GET[act] == "show") {
    ...
    // add links to packages.debian.org/<packagename>
    $content = "\n".$content;
    $content = preg_replace("/\\n([0-9a-z_\.-]*) /i", "\n<a href='http://packages.debian.org/\\1' target='_blank' title='Debian package-search for \\1'>\\1</a> ", $content);
    $content = preg_replace("/^\\n/", "", $content);
