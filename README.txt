...
Robert Klikics, RobHost GmbH [rk@robhost.de], 2007-2011
...
Updian is a minimalistic update-engine for DEBIAN GNU/Linux based machines (and other flavours like Ubuntu based on APT).
